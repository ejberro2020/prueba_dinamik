...
registerBlockType('wp-booking-system/overview-calendar', {
    ...
    edit: function edit(props) {
        ...
        var selected = typeof props.attributes.calendars != 'undefined' ? JSON.parse(props.attributes.calendars) : {};
        var handleSelectChange = function handleSelectChange(calendars) {
            return props.setAttributes({ calendars: JSON.stringify(calendars) });
        };
        ...
        return [wp.element.createElement(ServerSideRender, {
            ...
            wp.element.createElement(
                ...
                wp.element.createElement(
                    'p',
                    { 'class': 'description' },
                    __('Select the calendars you wish to display in the overview, or leave empty to show all calendars.', 'wp-booking-system')
                )
            ),
            wp.element.createElement(
                PanelBody,
                ...
                wp.element.createElement(SelectControl, {
                    ...
                    options: [{ value: 'top', label: __('Top', 'wp-booking-system') }, { value: 'bottom', label: __('Bottom', 'wp-booking-system') }],
                    onChange: function onChange(new_value) {
                ...
                wp.element.createElement(SelectControl, {
                    ...
                    options: start_year,
                    onChange: function onChange(new_value) {
                        return props.setAttributes({ start_year: new_value });
                    } }),
                wp.element.createElement(SelectControl, {
                    ...
                    options: start_month,
                    onChange: function onChange(new_value) {
                        return props.setAttributes({ start_month: new_value });
                    } })
            ),
            wp.element.createElement(
                PanelBody,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_memoize_one__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_emotion__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_raf__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_raf___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_raf__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_react_input_autosize__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_react_transition_group__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_create_emotion__ = __webpack_require__(15);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__emotion_memoize__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__emotion_unitless__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__emotion_hash__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__emotion_stylis__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_stylis_rule_sheet__ = __webpack_require__(20);
...
var _TransitionGroup = _interopRequireDefault(__webpack_require__(10));

var _Transition = _interopRequireDefault(__webpack_require__(7));
...
var _addClass = _interopRequireDefault(__webpack_require__(32));
