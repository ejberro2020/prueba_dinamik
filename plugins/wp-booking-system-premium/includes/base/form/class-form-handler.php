...
class WPBS_Form_Handler
{
    ...
    protected function create_booking()
    {
        ...
        $booking_data = array(
            ...
            'status' => apply_filters('wpbs_new_booking_status', 'pending', $this->form_id, $this->calendar_id),
            'is_read' => '0',
        ...
        wpbs_update_booking_meta($this->booking_id, 'customer_ip', wpbs_get_user_ip_address());
    ...
    protected function create_events()
    {
        ...
        if ($selection_style == 'split') {
            ...
            $start_day_event = wpbs_get_ical_event_by_date($this->calendar_id, $start_day['date_day'], $start_day['date_month'], $start_day['date_year']);
            ...
            $end_day_event = wpbs_get_ical_event_by_date($this->calendar_id, $end_day['date_day'], $end_day['date_month'], $end_day['date_year']);
